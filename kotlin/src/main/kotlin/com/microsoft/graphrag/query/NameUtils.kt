 ...
 *
 * Trims leading and trailing whitespace, substitutes `"index"` when the trimmed name is empty, and replaces
 * each sequence of whitespace characters with a single underscore.
 *
